import { FantasyStats, GameStatus, SleeperGame } from '../../shared/types'
...
export const mapScheduleDataToSchedule = (data: any): SleeperGame[] => {
  return data.map((d: any) => ({
    ...
    teams: [d.home, d.away],
    date: d.date,
    status: mapGameStatus(d.status),
  }))
}

export const mapGameStatus = (status: any) => {
  if (status === 'complete') return GameStatus.Complete
  else return GameStatus.PreGame
}
